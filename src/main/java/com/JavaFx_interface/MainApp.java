...
import crypto.view.EnterController;
import crypto.view.MenuController;
import crypto.view.RegController;
...
public class MainApp extends Application {
      ...
      public void start(Stage primaryStage) throws Exception {
       ...
       public static void  initShowReg(){
        try {
            ...
            loader.setLocation(MainApp.class.getResource("view/Reg.fxml"));
    ...
    public static void initShowEnter(){
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("view/Enter.fxml"));
            AnchorPane page = (AnchorPane) loader.load();
